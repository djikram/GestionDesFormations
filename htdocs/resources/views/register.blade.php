...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset ('resources/assets/img/favicon/favicon.ico')}}" />
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="{{asset ('resources/assets/vendor/libs/formvalidation/dist/css/formValidation.min.css')}}" />
      ...
      <div class="authentication-inner row">
        ...
        <div class="d-none d-lg-flex col-lg-7 p-0">
          <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
            <img
              src="{{asset ('resources/assets/img/illustrations/auth-register-illustration-light.png')}}"
            ...
            <img
              src="{{asset ('resources/assets/img/illustrations/bg-shape-image-light.png')}}"
              alt="auth-register-cover"
              class="platform-bg"
